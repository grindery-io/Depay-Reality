...
describe("GRTPOOL", function () {
  ...
  it("Test should deposit GRT and create a question, answer the question, claim winnings and distribute funds", async function () {
    ...
    //   initialize pool and dispute contracts
    ...
    // deposit GRT by initial user who wants to obtain some ERC20tokens
    await GRTPOOL.depositGRT(
      "2000000000000000000",
    ...
    expect(res.userAddr).to.equal("2000000000000000000");
    ...
    //   const questionStr = 'Did I make a transaction deposit of 1000GRT?␟ transaction ␟en'
    ...
    //   const _answerQuestion = await GRTPOOL.connect(userC).answerQuestion('true', questionId, 0, { value: ethers.utils.parseEther("1") });
    ...
    //   expect (canWithdrawA).to.equal(false)
    ...
    //   console.log('yess')
    //   await GRTPOOL.connect(userB).claimDepositExchange(questionId, userA.address)
    //   console.log(
    //   'yayy'
    //   )
