...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  console.log("--------------------- GRT Satellite - upgrade ---------------------");
  ...
  if (
    ...
    console.log(`Upgrading implementation of GrtSatellite (${GrtSatellite.address}) to ${impl.address}`);
...
func.dependencies = ["GrtSatellite_GrtSatellite", "GrtSatellite_GrtSatelliteImpl"];
export default func;
