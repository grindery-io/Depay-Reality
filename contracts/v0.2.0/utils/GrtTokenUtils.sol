...
contract GrtTokenUtils {
    ...
    event LogStake(address indexed _user, uint256 indexed _chainId, uint256 indexed _amount);
    event LogUnStake(address indexed _user, uint256 indexed _chainId, uint256 indexed _amount);
    ...
    function stakeGRT(uint256 amount, uint256 chainId) external returns (bool) {
        depositGRT(amount);
    ...
    function unstakeGRT(uint256 amount, uint256 chainId) external returns (bool) {
    ...
    function stakeOf(address account, uint256 chainId) external view returns (uint256) {
