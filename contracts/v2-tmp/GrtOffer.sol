...
contract GrtOffer is GrtOfferUtils {
    ...
    event LogSetMinPriceLimit(bytes32 indexed _offerId, bytes32 indexed _lowerLimitFn);
    event LogSetMaxPriceLimit(bytes32 indexed _offerId, bytes32 indexed _upperLimitFn);
